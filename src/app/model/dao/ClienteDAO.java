...
public class ClienteDAO {
    ...
    public boolean inserir(Cliente cliente) {
        String sql = "INSERT INTO clientes(nome, cpf, telefone, usuario, senha, nivelAcesso) VALUES(?,?,?,?,?,?)";
        try {
            ...
            stmt.setString(6, cliente.getNivelAcesso());
            stmt.execute();
            return true;
    ...
    public List<Cliente> listar() {
        ...
        try {
            ...
            while (resultado.next()) {
                ...
                cliente.setNivelAcesso((resultado.getString("nivelAcesso")));
                retorno.add(cliente);
            }
        } catch (SQLException ex) {
            Logger.getLogger(ClienteDAO.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public Cliente buscar(Cliente cliente) {
        ...
        try {
            ...
            if (resultado.next()) {
                cliente.setNome(resultado.getString("nome"));
                cliente.setEndereco(resultado.getString("cpf"));
                cliente.setTelefone(resultado.getString("telefone"));
                retorno = cliente;
            }
        } catch (SQLException ex) {
